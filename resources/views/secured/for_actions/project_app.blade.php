      ...
      <section class="content container-fluid">
        <div class="box box-default">
            <div style="padding:10px;">
                <div class='col-md-12'>
                    <div class="col-md-1">
                        <img id="ContentPlaceHolder1_Image2" src="../img/gear.jpeg" style="width:80px;">
                    </div>
                    <div class="col-md-11">
                        <h3><b>{{ $project['ProjectName']}} - Somewhere, Maasim, Saranggani
                    <br>Purpose: {{ $project['Purpose']}} of {{ $project['PreviousECCNo']}}</b></h3>
                    </div>
                </div>
                ...
                <div class="dvinfo">
                    ...
                    <div style="padding-top:20px; padding-bottom:20px;">
                        <b>Recent Activity:</b> <a id="ContentPlaceHolder1_hlLastComment" href="javascript:__doPostBack('ctl00$ContentPlaceHolder1$hlLastComment','')" style="text-decoration:none;">{{$project['Remarks']}}</a> 
                    </div>
