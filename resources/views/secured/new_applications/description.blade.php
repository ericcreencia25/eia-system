    ...
    <div class="box-body">
      <h4><b>3. DESCRIPTION OF PROPOSED PROJECT:</b><br></h4>
      ...
      <div style="border:Solid 1px Silver;">
        <textarea rows="2" cols="20" style="font-family:Tahoma;font-size:Small;height:200px;width:98.3%;padding:10px; border:none;">{{$project['Description']}}</textarea>
      </div>
    </div>