...
Partial Class Secured_Templates_SwornStatement
    ...
    Private Sub GenerateOrder(ByVal p As Project)
        ...
        Dim c9a As PdfPCell = New PdfPCell(New Phrase("Total Application Fee (MC 2018-002)", fb))
        c9a.Border = 0
        t.AddCell(c9a)
        ...
        Dim c18a As PdfPCell = New PdfPCell(New Phrase("NOTE: RETAIN A COPY OF THE ORDER OF PAYMENT. SINGLE BANK RECEIPT PER ORDER OF PAYMENT. SAME BANK PAYMENT TRANSACTION NUMBER WILL NOT BE ACCEPTED.PAYMENT NON-REFUNDABLE.", fl))
