...
Partial Class Secured_Templates_AnnotatedPrint
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        strBody.Append("<style>" & _
                                ...
                                "   mso-footer-margin:1in; mso-paper-source:0;} .thintable{ border-spacing:0; border-collapse:collapse;} .thintable td{  border: 1px solid black; border-width:thin; vertical-align:top;}" & _
                                " div.Section1" & _
                                "   {page:Section1;} " & _
                                "-->" & _
                               "</style></head>")
